...
class FBNetPipeline(ImageNetPipeline): ...
...
def main():
    ...
    pipeline = FBNetPipeline.create_from_args(args, stop_condition, logger, preproc=fbnet_preproc)

...
NUM_STREAMS = 2
THRESHOLD = 0.5
SAMPLE_NAME = "SwinTransformer"
MODEL_NAME = "swin_transformer"
NUM_FRAMES = 40_000


def swin_transformer_preproc(model, ppp):
...
class SwinTransformer(ImageNetPipeline): ...
...
def main():
    ...
    pipeline = SwinTransformer.create_from_args(
        args, stop_condition, logger, preproc=swin_transformer_preproc
    )
